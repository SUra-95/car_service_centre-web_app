                        ...
                        <tr>
                            ...
                            <td class="border px-4 py-2 ">
                                @if ($job->status === 'pending')
                                    <span
                                        class="inline-flex items-center px-3 py-1 rounded-md text-sm font-medium border border-orange-600 text-orange-600">
                                        {{ __('Pending') }}
                                    </span>
                                @elseif($job->status === 'completed')
                                    <span
                                        class="inline-flex items-center px-3 py-1 rounded-md text-sm font-medium border border-green-400 text-green-600">
                                        {{ __('Completed') }}
                                    </span>
                                @endif
                            </td>
